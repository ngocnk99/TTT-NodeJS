CREATE DATABASE IF NOT EXISTS `core_connect_care`
...
VALUES (
		...
		NULL,
		'Giúp chủ nhà thuốc tối ưu được các hoạt động quản lý với hệ thống tra cứu và báo cáo theo nhiều tiêu chí khác nhau. ',
		1,
		23,
		29,
		1,
...
(
		33,
		'Phân phối phần mềm cho máy tính và mobile',
		NULL,
		'Phân phối các ứng dụng phần mềm cho các thiết bị máy tính và di động.',
		1,
		24,
		27,
		1,
...
VALUES (23, 'Video', 1, 1, '2019-09-23 17:57:16', _binary ''),
(
		24,
		'Slide',
		1,
...
(25, 'Text', 1, 1, '2019-09-23 18:07:11', _binary ''),
(26, 'Gif', 1, 1, '2019-09-23 18:07:54', _binary '');
...
(
		33,
		'Khi nào nên sử dụng phần mềm quản lý nhà thuốc',
		'Việc sử dụng phần mềm quản lý chắc cũng không còn là khái niệm xa lạ với các nhà đầu tư, từ những chủ đầu tư hàng hóa cho đến các chủ cửa hàng dịch vụ…. Tuy nhiên, rất nhiều trong số họ vẫn chưa muốn dùng phần mềm, bởi chưa thấy được lợi ích mà phần mềm mang lại.',
		...
		'userfiles/admin_nbm/images/20191010/2019_10_10_16_48_42_301_tv2x.png',
		NULL,
		'https://xpharma.vn/khi-nao-nen-su-dung-phan-mem-quan-ly.html',
		NULL,
		'',
		'',
		21,
...
(
		...
		'userfiles/admin_nbm/images/20191011/2019_10_11_9_28_47_105_photo20191011090644.jpg',
		NULL,
		NULL,
		NULL,
		'',
...
(
		37,
		'Quản lý chuỗi nhà thuốca',
		'1,1,1',
		'',
		'userfiles/admin_nbm/images/20191011/2019_10_11_9_8_59_164_photo20191011090644.jpg',
		'Mobile',
		NULL,
		NULL,
		'',
...
(
		...
		'0,0,1',
		'',
		'userfiles/admin_nbm/images/20191011/2019_10_11_9_10_58_732_photo201910110906432.jpg',
		'Mobile',
		NULL,
		NULL,
		'',
...
(
		40,
		'Dùng thuốc giảm cân lợi bất cập hại',
...
(
		...
		'Long waiting lines and disorganized waiting rooms are among the top 3 reasons why customers bail on businesses. Waiting is just another part of your service package, and it can make or break your customers’ experience.\n\n',
		'',
		'userfiles/admin_nbm/images/20191011/2019_10_11_18_38_26_94_macbook2x.png',
		NULL,
		NULL,
		NULL,
		'',
...
(
		43,
		'Redmi Nott ',
		'Redmi Nott Redmi Nott Redmi Nott Redmi Nott Redmi Nott ',
		'',
		'userfiles/admin_nbm/images/20191011/2019_10_11_18_38_10_400_welcome2x.png',
		NULL,
		NULL,
		NULL,
		'',
...
(
		28,
		'Trung tâm nghiên cứu sinh học và y dược',
		1,
		'2019-09-23 10:58:15',
		_binary ''
	),
...
;
INSERT INTO `group_sites`
VALUES (1, 'Quản trị', 1, '2019-09-12 15:11:31', _binary ''),
(
		40,
		'Landing page',
		1,
...
(42, 'csd', 1, '2019-09-30 14:25:08', _binary ''),
(
		43,
		'Giới thiệu',
		1,
...
;
INSERT INTO `med_goods_issue_detail`
VALUES (1, 1, 3, 1, 1, 1, 10000, 1, 1, 35, 0, _binary '', 'uoongs'),
(
		2,
		2,
		3,
...
;
INSERT INTO `med_goods_issue_receipt_detail`
VALUES (1, 5, 1, 1, _binary '', 1),
(2, 5, 1, 2, _binary '', 2);
...
;
INSERT INTO `med_goods_receipts`
VALUES (
		1,
		'KL20055',
		'Đỗ Minh Thư',
...
;
INSERT INTO `med_group_customers`
VALUES (
		1,
		'Khách hàng bác sĩ',
		'2019-09-25 13:34:49',
...
;
INSERT INTO `med_group_medicines`
VALUES (
		1,
		'Nhóm thuốc tim mạch',
		'2019-09-24 22:53:43',
...
(
		15,
		'Nhóm thuốc điều trị suy tim sung huyết',
		'2019-10-02 18:31:01',
		28,
		1,
		35,
...
(
		16,
		'Nhóm thuốc điều trị thiếu máu cục bộ',
		'2019-10-02 18:31:20',
		28,
		1,
		35,
...
(
		17,
		'Nhóm thuốc điều trị loạn nhịp tim',
		'2019-10-02 18:31:34',
		28,
		1,
		35,
...
(
		19,
		'Nhóm thuốc chống choáng và chống sốc',
		'2019-10-02 18:32:52',
		28,
		1,
		35,
...
(
		24,
		'THUỐC GIẢM ĐAU VÀ HẠ SỐT NHÓM CHỐNG VIÊM',
		'2019-10-02 18:35:59',
		28,
		0,
		35,
...
;
INSERT INTO `med_group_producers`
VALUES (
		1,
		'Đông y',
		NULL,
...
;
INSERT INTO `med_group_suppliers`
VALUES (
		1,
		'Nhóm nhà cung cấp thuốc đông y và lá thuốc',
		'2019-09-25 13:40:11',
		1,
		35,
		_binary ''
...
(
		4,
		'Nhóm nhà cung cấp thuốc và thảo dược',
		'2019-09-25 13:44:45',
		1,
		35,
		_binary ''
...
(
		5,
		'Nhà cung cấp thực phẩm chức năng',
		'2019-09-25 16:24:09',
		28,
		35,
		_binary ''
...
(
		6,
		'Nhà cung cấp trang thiết bị y tế và vật tư y tế',
		'2019-09-25 16:24:35',
		28,
		35,
		_binary ''
...
(12, 'Abc', '2019-10-14 10:30:45', 1, 35, _binary '');
...
;
INSERT INTO `med_medicine_locations`
VALUES (
		1,
		'Dưới trái',
		'Dưới trái',
...
(
		2,
		'Công Ty Cổ Phần Dược Phẩm Trung Ương I và Pharbaco',
		'160 Tôn Đức Thắng, Q. Đống Đa, Hà Nội, Việt Nam',
		'2019-09-26 11:46:58',
		3,
		28,
		35,
...
(
		...
		'Số 10A Quang Trung, Quận Hà Đông, Hà Nội, Việt Nam\n',
		'2019-09-30 11:08:48',
		4,
		28,
		35,
...
(
		4,
		'Công Ty CP Nông Nghiệp Công Nghệ Cao Thăng Long',
		'Xã Đại Yên, Chương Mỹ, Hà Nội, Việt Nam',
		'2019-09-30 13:52:11',
		4,
		28,
		35,
...
(
		...
		'Lô 08,09 CCN và TTCN Tân Mỹ Chánh, P.9, TP Mỹ Tho, Tiền Giang',
		'2019-10-08 09:03:00',
		4,
		1,
		35,
...
(
		11,
		'Cty TNHH sản xuất thương mại dược phẩm NIC (NIC pharma)',
		'Việt Nam',
		'2019-10-08 09:19:06',
		4,
		32,
...
;
INSERT INTO `med_suppliers`
VALUES (
		1,
		'Công Ty Cổ Phần Dưỡng Dược Vĩnh Kim',
		'0101054925',
		'186 Định Công Hạ, P. Định Công, Q. Hoàng Mai,Hà Nội',
		'2019-09-25 14:48:21',
		'0919559698',
		'kimluan32@gmail.com',
		'',
		'www.duocvinhkim.com',
		'Công Ty CP Dưỡng Dược Vĩnh Kim chuyên sản xuất và cung cấp thảo dược và sản phẩm từ thảo dược với chất lượng đảm bảo, giá cả hợp lý, uy tín, chuyên nghiệp trên toàn quốc.',
		5,
		1,
		35,
		_binary ''
...
(
		...
		'Công Ty CP Nông Nghiệp Công Nghệ Cao Thăng Long',
		'0101054925',
		'Xã Đại Yên, Chương Mỹ,Hà Nội',
		'2019-09-25 14:49:03',
		'0972339095',
		'cagaileosadu@gmail.com',
		'',
		'www.cagaileosadu.com.vn',
		'Cà Gai Leo Sadu - sản phẩm được sản xuất bởi Công Ty Công Nghệ Cao Thăng Long.\nHiện tại Cà Gai Leo Sadu đang phân phối những sản phẩm chính như: Cao Cà Gai Leo Sadu, Cà Gai Leo Hoà Tan Sadu, Cà Gai Le',
		7,
		1,
		35,
		_binary ''
...
(
		3,
		'Rượu Thuốc Xoa Bóp Gia Truyền Hồng Phong',
		'0101054925',
		'99 Đường Số 8, P. 4, Q. 8,Tp. Hồ Chí Minh (TPHCM)',
		'2019-09-25 14:49:06',
		'0902216004',
		'rxbhongphong@gmail.com',
		'userfiles/admin_nbm/images/20191008/2019_10_08_10_13_12_396_download.png',
		'www.plus.google.com/u/0/115407584113782720816',
		'Với rất nhiều công dụng hoàn hảo từ bài thuốc gia truyền lâu đời, khẳng định từ cổ chí kim chưa có bài thuốc, loại Rươụ nào chữa được nhiều bệnh như vậy. Toàn bộ bệnh ngoài cơ thể đều ước lượng thời g',
		1,
		1,
		35,
		_binary ''
...
(
		...
		'Eva Shop',
		'123456',
		'475 Đoàn Văn Bơ, Phường 14, Quận 4,Tp. Hồ Chí Minh (TPHCM)',
		'2019-09-26 12:07:24',
		'0903070384',
		'xuandiemthaicorp@gmail.com',
		'',
		'www.evachamsocda.com',
		'Chúng tôi chuyên cung cấp sỉ, lẻ Nấm giảm cân thảo dược, nhă hỗ trợ khách han giảm cân an toàn, sớm đạt được cân nặng như ý.',
		1,
		28,
		35,
		_binary ''
...
(
		5,
		'Công Ty Cổ Phần Difoco',
		'0313240560',
		'289 Đinh Bộ Lĩnh, P. 26, Q. Bình Thạnh,Tp. Hồ Chí Minh (TPHCM)',
		'2019-09-27 11:22:23',
		'0366857787',
		'info@difoco.com',
		'',
		'www.difoco.com',
		'Công ty cổ phần DIFOCO kinh doanh chuyên về dược phẩm & thực phẩm bảo vệ sức khỏe có nguồn gốc từ thảo dược thiên nhiên.',
		4,
		1,
		35,
		_binary ''
...
(
		...
		'0313614992',
		'37/5B Trung Mỹ Tây, Trung Chánh, Hóc Môn,Tp. Hồ Chí Minh (TPHCM)',
		'2019-09-27 11:35:48',
		'0871066869',
		'info@neemtree.vn',
		'',
		'www.neemtree.vn',
		'Công Ty Cổ Phần NeemTree được sếp vào top 5 các thương hiệu thảo dược hàng đầu tại Việt Nam trong lĩnh vực thảo dược hỗ trợ điều trị các bệnh như tiểu đường, huyết áp thấp, sỏi thận và xương khớp,..',
		2,
		1,
		35,
		_binary ''
...
(
		...
		'Công Ty TNHH Lê Hào',
		'0101054925',
		'26/36 Đường Thượng Hội, Xã Tân Hội, H. Đan Phượng Hà Nội',
		'2019-09-27 11:42:16',
		'0337190219',
		'sales.lehaoco@gmail.com',
		'',
		'TNHH Lê Hào',
		'Công ty TNHH Lê Hào chuyên cung cấp nông sản (gia vị, có dầu), thảo dược, tinh dầu,..',
		6,
		1,
		35,
		_binary ''
...
(
		...
		'0433522525',
		'duochatay@gmail.com',
		'userfiles/admin_nbm/images/20191009/2019_10_09_15_43_27_984_photo20190821113127.jpg',
		'hataphar.com.vn',
		NULL,
		3,
		32,
...
(
		...
		'3700575898 ',
		'Đường D17, Khu Công Nghiệp Mỹ Phước 1, Bến Cát - Bình Dương, Việt Nam',
		'2019-10-09 15:49:54',
		'02743567687',
		NULL,
		'',
...
;
INSERT INTO `med_units`
VALUES (1, 'Viên', '2019-09-25 14:52:18', 1, _binary ''),
(2, 'Gói', '2019-09-25 14:52:33', 1, _binary ''),
(3, 'Lọ', '2019-09-25 14:52:40', 1, _binary ''),
(4, 'Thùng', '2019-09-25 14:52:43', 1, _binary ''),
(5, 'Kim tiêm', '2019-09-25 14:52:48', 1, _binary ''),
(7, 'Ống', '2019-09-27 10:41:43', 28, _binary ''),
(11, 'Miếng', '2019-09-27 10:54:02', 28, _binary ''),
(12, 'Túi', '2019-09-27 11:12:47', 28, _binary ''),
(14, 'Tuýp', '2019-09-27 11:44:30', 28, _binary ''),
(21, 'Vỉ', '2019-09-30 13:33:14', 28, _binary ''),
(22, 'Hộp', '2019-09-30 14:49:08', 28, _binary ''),
(24, 'DV1', '2019-10-14 10:44:13', 1, _binary ''),
(25, 'DVS1', '2019-10-14 10:44:28', 1, _binary ''),
(26, 'DVT3', '2019-10-14 10:48:45', 1, _binary ''),
(27, 'DVT4', '2019-10-14 10:48:54', 1, _binary ''),
(28, 'DVT6', '2019-10-14 10:49:00', 1, _binary '');
...
;
INSERT INTO `med_warehouses`
VALUES (
		4,
		'Kho thuốc Hai Bà Trưng Hà Nội',
		'102 Hai bà Trưng\n',
		49,
		35,
		'2019-09-27 14:47:12',
...
(
		7,
		'Kho quầy thuốc Thu Loan',
		'số 8 trung yên 9, tòa Vinahub',
		23,
		35,
		'2019-09-30 11:13:09',
		28,
...
;
INSERT INTO `med_warehouses_details`
VALUES (20, 35, 2, 200, 5996),
(21, 35, 4, 200, 1100);
...
(2, 'Menu con', 1, '2019-09-13 15:55:16', _binary ''),
(
		3,
		'Vị trí Menu Bottom',
		1,
...
(
		18,
		'Quản lý nhóm website',
		1,
		'/category/groupWebsites',
		NULL,
		46,
		1,
		5,
...
(
		22,
		'Quản lý giao diện danh mục',
		1,
		'/category/templateLayouts',
		NULL,
		37,
		1,
		5,
...
(
		28,
		'Quản lý nhóm nhà sản xuất',
		1,
		'/category/groupProducers',
		NULL,
		57,
		1,
		3,
...
(
		...
		'Danh mục 1',
		15,
		'http://pharmacy.connectcare.vn/category/danhmuc1',
		NULL,
		0,
		2,
		1,
...
VALUES (1, 'Tiền mặt', '2019-09-25 14:55:48', 1, _binary ''),
(
		2,
		'Ví điện tử MOMO',
		'2019-09-25 14:56:04',
...
(9, 'Mã QR', '2019-10-07 09:30:04', 28, _binary '');
...
VALUES (
		...
		'Quầy thuốc Thu Loan',
		'0339943399',
		'Cụm 6, xã Tân Lập, huyện Đan Phượng, thành phố Hà Nội (nhà ông Lê Tiến Liên)',
		'Nguyễn Thị Thu Loan',
		'0339943399',
		NULL,
		'01-002001',
		'gpp_01_002001_043704',
		'123456a',
		1,
		'2019-09-24 16:31:38',
		19,
...
(
		38,
		'CTY CỔ PHẦN TRUYỀN THÔNG KHỞI ĐẦU MỚI',
		'0929890086',
		'Tòa nhà Vinahud',
		'Vũ Văn Tuyển',
		'0929890086',
...
VALUES (435, 35, 1, 1, '2019-09-25 10:42:02', _binary ''),
(436, 36, 1, 1, '2019-09-25 10:42:02', _binary ''),
(442, 35, 28, 1, '2019-09-26 15:56:29', _binary ''),
(443, 35, 27, 1, '2019-09-27 09:36:43', _binary ''),
(447, 35, 29, 29, '2019-10-01 15:26:44', _binary ''),
(448, 36, 29, 29, '2019-10-01 15:26:44', _binary ''),
(449, 37, 29, 29, '2019-10-01 15:26:44', _binary ''),
(452, 35, 32, 1, '2019-10-04 09:20:43', _binary ''),
(455, 35, 33, 1, '2019-10-04 13:51:08', _binary '');
...
VALUES (18, 'Hà Nội', 1, '2019-09-23 13:46:10', _binary ''),
(
		19,
		'Hải Dương',
		1,
...
(27, 'Nghệ An', 1, '2019-09-23 13:48:08', _binary ''),
(28, 'Lào Cai', 1, '2019-09-23 13:48:14', _binary ''),
(29, 'Hà Nam', 1, '2019-09-23 13:48:31', _binary ''),
(30, 'Hà Tĩnh', 1, '2019-09-23 13:48:50', _binary ''),
(
		31,
		'Vĩnh Phúc',
		1,
...
(32, 'Yên Bái', 1, '2019-09-23 13:49:10', _binary ''),
(33, 'Sơn La', 1, '2019-09-23 13:49:19', _binary ''),
(
		34,
		'Ninh Bình',
		1,
...
(39, 'Bà Rịa ', 1, '2019-09-23 13:51:28', _binary ''),
(40, 'Bắc Kạn', 1, '2019-09-23 13:51:38', _binary ''),
(
		41,
		'Bạc Liêu',
		1,
...
(42, 'Bến Tre', 1, '2019-09-23 13:52:05', _binary ''),
(
		43,
		'Bình Định',
		1,
...
(47, 'Cà Mau', 1, '2019-09-23 13:52:50', _binary ''),
(48, 'Đắk Lắk', 1, '2019-09-23 13:53:00', _binary ''),
(
		49,
		'Đắk Nông',
		1,
...
(52, 'Gia Lai', 1, '2019-09-23 13:53:38', _binary ''),
(
		53,
		'Hậu Giang',
		1,
...
(57, 'Kon Tum', 1, '2019-09-23 13:54:47', _binary ''),
(
		58,
		'Lai Châu',
		1,
...
(61, 'Long An', 1, '2019-09-23 13:55:19', _binary ''),
(
		62,
		'Ninh Thuận',
		1,
...
(76, 'Phú Yên', 1, '2019-09-23 13:57:41', _binary ''),
(77, 'Cần Thơ', 1, '2019-09-23 13:57:49', _binary ''),
(78, 'Đà Nẵng', 1, '2019-09-23 13:57:57', _binary ''),
(79, 'TP HCM', 1, '2019-09-23 13:58:14', _binary ''),
(80, 'Phú Thọ', 1, '2019-09-23 14:43:20', _binary '');
...
(
		14,
		'web giới thiệu quản lý nhà thuốc',
		'http://pharmacy.connectcare.vn',
		NULL,
		NULL,
		1,
...
(
		15,
		'Phần mềm bán hàng nhà thuốc',
		'http://camgroup.com.vn/phan-mem/phan-mem-quan-ly-nha-thuoc-chuoi-nha-thuoc.aspx',
		NULL,
		NULL,
		1,
		35,
...
/*!40101 SET character_set_client = utf8 */
;
CREATE TABLE `t_byCustomerID` (`txt` text) ENGINE = InnoDB DEFAULT CHARSET = utf8;
/*!40101 SET character_set_client = @saved_cs_client */
;
--
...
/*!40101 SET character_set_client = utf8 */
;
CREATE TABLE `t_byMedicinesID` (`txt` text) ENGINE = InnoDB DEFAULT CHARSET = utf8;
/*!40101 SET character_set_client = @saved_cs_client */
;
--
...
/*!40101 SET character_set_client = utf8 */
;
CREATE TABLE `t_byUserID` (`txt` text) ENGINE = InnoDB DEFAULT CHARSET = utf8;
/*!40101 SET character_set_client = @saved_cs_client */
;
--
...
/*!40101 SET character_set_client = utf8 */
;
CREATE TABLE `t_medicine_ExpiredDate` (`txt` text) ENGINE = InnoDB DEFAULT CHARSET = utf8;
/*!40101 SET character_set_client = @saved_cs_client */
;
--
...
;
INSERT INTO `t_medicine_ExpiredDate`
VALUES ('7');
...
/*!40101 SET character_set_client = utf8 */
;
CREATE TABLE `t_medicine_OutofStock` (`txt` text) ENGINE = InnoDB DEFAULT CHARSET = utf8;
/*!40101 SET character_set_client = @saved_cs_client */
;
--
...
;
INSERT INTO `t_medicine_OutofStock`
VALUES ('35');
...
VALUES (
		1,
		'Giao diện 4 tin nằm ngang tiêu đề và ảnh',
		'templateLayout_6',
		1,
		'2019-09-13 14:50:55',
		_binary ''
...
(
		19,
		'Giao diện 3 tin và 1 tin nổi bật kiểu 3',
		'templateLayout_4',
		1,
		'2019-09-24 16:40:51',
		_binary ''
...
(
		20,
		'Giao diện tiêu đề và nội dung chi tiết',
		'templateLayout_3',
		29,
		'2019-09-26 10:57:08',
		_binary ''
...
(
		21,
		'Giao diện nhiều tin nội dung và ảnh chia đôi',
		'templateLayout_2',
		1,
		'2019-10-07 15:58:57',
		_binary ''
...
(
		23,
		'Giao diện 3 tin và 1 tin nổi bật kiểu 2',
		'templateLayout_7',
		1,
		'2019-10-09 16:52:16',
		_binary ''
...
(
		24,
		'Giao diện 3 tin và 1 tin nổi bật kiểu 4',
		'templateLayout_8',
		1,
		'2019-10-09 16:52:31',
		_binary ''
...
(
		25,
		'Giao diện 3 tin và 1 tin nổi bật kiểu 1',
		'templateLayout_9',
		1,
		'2019-10-09 16:52:43',
		_binary ''
...
(
		26,
		'Giao diện 3 tin nằm ngang có ảnh kiểu 1',
		'templateLayout_10',
		1,
		'2019-10-09 16:52:57',
		_binary ''
...
(
		28,
		'Giao diện 3 tin nằm ngang có ảnh kiểu 2',
		'templateLayout_12',
		1,
		'2019-10-09 16:53:29',
		_binary ''
...
(
		29,
		'Giao diện 2 tin chia đôi màn hình có vách ngăn',
		'templateLayout_13',
		1,
		'2019-10-09 16:53:46',
		_binary '\0'
...
(
		30,
		'Giao diện nhiều tin có phân trang',
		'templateLayout_14',
		1,
		'2019-10-09 16:53:59',
		_binary ''
...
DELIMITER;
;
CREATE DEFINER = `root` @`%` PROCEDURE `sp_med_goods_issues_getByid`(in in_goodIssueId bigint) BEGIN
select issue.id,
	issue.good_issue_code,
	...
	(
		case
			when issue_detail.is_retail = true then 1
			else issue_detail.coefficient
		end
	) as ty_le_quy_doi
...
CREATE DEFINER = `root` @`%` PROCEDURE `sp_med_goods_issues_insert`(
	...
	out out_output int -- 1: thành công
...
END;
START TRANSACTION;
set in_length_goods_isssues_detail = JSON_LENGTH(
		JSON_EXTRACT(in_goodsIssues, '$.goodsIssues.detail')
	);
if(in_length_goods_isssues_detail = 0) then
set out_output = 0;
ROLLBACK;
else
set in_issue_code = JSON_UNQUOTE(
		JSON_EXTRACT(in_goodsIssues, '$.goodsIssues.issueCode')
	);
set in_users_seller_id = JSON_UNQUOTE(
		JSON_EXTRACT(in_goodsIssues, '$.goodsIssues.usersSellerId')
	);
set in_payment_methods_id = JSON_UNQUOTE(
		JSON_EXTRACT(in_goodsIssues, '$.goodsIssues.paymentMethodsId')
	);
set in_warehouses_id = JSON_UNQUOTE(
		JSON_EXTRACT(in_goodsIssues, '$.goodsIssues.warehousesId')
	);
set in_issues_date = STR_TO_DATE(
		JSON_UNQUOTE(
			JSON_EXTRACT(in_goodsIssues, '$.goodsIssues.issueDate')
		),
		'%Y-%m-%d %T'
	);
set in_debit = IF(
		JSON_UNQUOTE(
			JSON_EXTRACT(in_goodsIssues, '$.goodsIssues.debit')
		) = 'true',
		true,
		false
	);
set in_invoice_code = JSON_UNQUOTE(
		JSON_EXTRACT(in_goodsIssues, '$.goodsIssues.invoiceCode')
	);
set in_invoice_date = STR_TO_DATE(
		JSON_UNQUOTE(
			JSON_EXTRACT(in_goodsIssues, '$.goodsIssues.invoiceDate')
		),
		'%Y-%m-%d %T'
	);
set in_descriptions = JSON_UNQUOTE(
		JSON_EXTRACT(in_goodsIssues, '$.goodsIssues.descriptions')
	);
set in_customers_id = JSON_UNQUOTE(
		JSON_EXTRACT(in_goodsIssues, '$.goodsIssues.customersId')
	);
set in_users_creator_id = JSON_UNQUOTE(
		JSON_EXTRACT(in_goodsIssues, '$.goodsIssues.userCreatorsId')
	);
set in_places_id = JSON_UNQUOTE(
		JSON_EXTRACT(in_goodsIssues, '$.goodsIssues.placesId')
	);
set in_status = IF(
		JSON_UNQUOTE(
			JSON_EXTRACT(in_goodsIssues, '$.goodsIssues.status')
		) = 'true',
		true,
		false
	);
...
set in_is_retail = IF(
		JSON_UNQUOTE(
			JSON_EXTRACT(
				in_goodsIssues,
				concat('$.goodsIssues.detail[', _index, '].isRetail')
			)
		) = 'true',
		true,
		false
	);
set in_medicines_id = JSON_UNQUOTE(
		JSON_EXTRACT(
			in_goodsIssues,
			concat('$.goodsIssues.detail[', _index, '].medicinesId')
		)
	);
set in_units_id = JSON_UNQUOTE(
		JSON_EXTRACT(
			in_goodsIssues,
			concat('$.goodsIssues.detail[', _index, '].unitsId')
		)
	);
set in_quantities = JSON_UNQUOTE(
		JSON_EXTRACT(
			in_goodsIssues,
			concat('$.goodsIssues.detail[', _index, '].quantities')
		)
	);
set in_price = JSON_UNQUOTE(
		JSON_EXTRACT(
			in_goodsIssues,
			concat('$.goodsIssues.detail[', _index, '].price')
		)
	);
set in_dose_per_day = JSON_UNQUOTE(
		JSON_EXTRACT(
			in_goodsIssues,
			concat('$.goodsIssues.detail[', _index, '].dosePerDay')
		)
	);
set in_discounts = JSON_UNQUOTE(
		JSON_EXTRACT(
			in_goodsIssues,
			concat('$.goodsIssues.detail[', _index, '].discounts')
		)
	);
set in_quantities_per_time = JSON_UNQUOTE(
		JSON_EXTRACT(
			in_goodsIssues,
			concat(
				'$.goodsIssues.detail[',
...
set in_retailQuantities = JSON_UNQUOTE(
		JSON_EXTRACT(
			in_goodsIssues,
			concat(
				'$.goodsIssues.detail[',
...
set in_wholeSaleQuantities = JSON_UNQUOTE(
		JSON_EXTRACT(
			in_goodsIssues,
			concat(
				'$.goodsIssues.detail[',
...
set in_duongDung = JSON_UNQUOTE(
		JSON_EXTRACT(
			in_goodsIssues,
			concat('$.goodsIssues.detail[', _index, '].duongDung')
		)
	);
if (
	1 = ifnull(
		(
			select case
					when in_is_retail = true then if(
						(in_quantities) <= sum(receipt_detail.quantities_in_stock),
						1,
						1
					)
					else if(
						(in_quantities) <= (
							sum(receipt_detail.quantities_in_stock) /(
								sum(receipt_detail.retail_quantities) / sum(receipt_detail.quantities_received)
							)
						),
						1,
						1
...
SELECT in_goods_issues_id,
	in_medicines_id,
	in_units_id,
	in_quantities,
	in_price,
	in_dose_per_day,
	in_quantities_per_time,
	in_places_id,
	in_discounts,
	in_is_retail,
	(
		case
			when in_is_retail = true then 1
			else packages.quantities
		end
	),
	in_duongDung
...
select CASE
		when in_is_retail = true then if(
			in_quantities <= ifnull(receipt_detail.quantities_in_stock, 0),
			in_quantities,
			ifnull(receipt_detail.quantities_in_stock, 0)
		)
		else if(
			in_quantities <= ifnull(
				(
	...
	receipt_detail.id,
	CASE
		when in_is_retail = false then (
			receipt_detail.retail_quantities / receipt_detail.quantities_received
		)
		else 1
	end into i_quantites,
	i_goods_receipt_detail_id,
	i_coefficient
from med_goods_receipts as receipts
	inner join med_goods_receipt_detail as receipt_detail on receipt_detail.goods_receipts_id = receipts.id
where receipt_detail.medicines_id = in_medicines_id
...
set quantities_in_stock = quantities_in_stock - (
		case
			when in_is_retail = false then i_quantites * i_coefficient
			else i_quantites
		end
	)
...
-- set in_users_creator_id = JSON_UNQUOTE(JSON_EXTRACT(in_goodsIssues,'$.goodsIssues.userCreatorsId'));
set in_places_id = JSON_UNQUOTE(
		JSON_EXTRACT(in_goodsIssues, '$.goodsIssues.placesId')
	);
set in_status = IF(
...
update med_goods_issues
set issue_code = in_issue_code,
...
set in_goods_issues_detail_id = JSON_UNQUOTE(
		JSON_EXTRACT(
			in_goodsIssues,
			concat('$.goodsIssues.detail[', _index, '].id')
		)
	);
set in_medicines_id = JSON_UNQUOTE(
		JSON_EXTRACT(
...
set in_flag = JSON_UNQUOTE(
		JSON_EXTRACT(
			in_goodsIssues,
			concat('$.goodsIssues.detail[', _index, '].flag')
		)
	);
set in_duongDung = JSON_UNQUOTE(
		JSON_EXTRACT(
...
-- select in_flag;
if(in_status = true) then if(in_flag = 0) then
set in_whosale_quantities_old = IFNULL(
		(
			select quantities
			from med_goods_issue_detail
			where id = in_goods_issues_detail_id
				and is_retail = false
		),
		0
	);
set in_retail_quantities_old = IFNULL(
		(
			select quantities
			from med_goods_issue_detail
			where id = in_goods_issues_detail_id
...
if (
	1 = ifnull(
		(
			select case
					when in_is_retail = true then if(
						(in_quantities - in_retail_quantities_old) <= sum(receipt_detail.quantities_in_stock),
						1,
						0
					)
					else if(
						(in_quantities - in_whosale_quantities_old) <= sum(
							receipt_detail.quantities_in_stock /(
								receipt_detail.retail_quantities / receipt_detail.quantities_received
							)
						),
...
update med_goods_issue_detail
set goods_issues_id = in_goods_issues_id,
...
update med_goods_receipt_detail as tbl1,
	med_goods_issue_receipt_detail as tbl2
set tbl1.quantities_in_stock = tbl1.quantities_in_stock + tbl2.quantites * tbl2.coefficient
...
delete from med_goods_issue_receipt_detail
where goods_issue_detail_id = in_goods_issues_detail_id;
delete from med_goods_issue_detail
where id = in_goods_issues_detail_id;
elseif(in_flag = 1) then
insert into med_goods_issue_detail(
		goods_issues_id,
...
SELECT in_goods_issues_id,
	...
	(
		case
			when in_is_retail = true then packages.wholesale_quantities
			else 1
		end
	),
	in_duongDung
...
if (
	1 = ifnull(
		(
			...
			from med_goods_receipts as receipts
				inner join med_goods_receipt_detail as receipt_detail on receipt_detail.goods_receipts_id = receipts.id
			where receipt_detail.medicines_id = in_medicines_id -- and receipt_detail.quantities_in_stock >0
				and receipts.warehouses_id = in_warehouses_id
		),
		0
	)
) then while in_quantities > 0 do
select CASE
		when in_is_retail = true then if(
			in_quantities <= ifnull(receipt_detail.quantities_in_stock, 0),
			in_quantities,
...
END;
START TRANSACTION;
set in_length_goods_receipts_detail = JSON_LENGTH(
		JSON_EXTRACT(in_goodsReceipts, '$.goodsReceipts.detail')
	);
if(in_length_goods_receipts_detail = 0) then
set out_output = 0;
ROLLBACK;
else
set in_receipt_code = JSON_UNQUOTE(
		JSON_EXTRACT(in_goodsReceipts, '$.goodsReceipts.receiptCode')
	);
set in_shipper_name = JSON_UNQUOTE(
		JSON_EXTRACT(in_goodsReceipts, '$.goodsReceipts.shipperName')
	);
set in_payment_methods_id = JSON_UNQUOTE(
		JSON_EXTRACT(
			in_goodsReceipts,
			'$.goodsReceipts.paymentMethodsId'
		)
	);
set in_warehouses_id = JSON_UNQUOTE(
		JSON_EXTRACT(in_goodsReceipts, '$.goodsReceipts.warehousesId')
	);
set in_date_receipt = STR_TO_DATE(
		JSON_UNQUOTE(
			JSON_EXTRACT(in_goodsReceipts, '$.goodsReceipts.dateReceipt')
		),
		'%Y-%m-%d %T'
	);
set in_debit = IF(
		JSON_UNQUOTE(
			JSON_EXTRACT(in_goodsReceipts, '$.goodsReceipts.debit')
		) = 'true',
		true,
		false
	);
set in_invoice_code = JSON_UNQUOTE(
		JSON_EXTRACT(in_goodsReceipts, '$.goodsReceipts.invoiceCode')
	);
set in_invoice_date = STR_TO_DATE(
		JSON_UNQUOTE(
			JSON_EXTRACT(in_goodsReceipts, '$.goodsReceipts.invoiceDate')
		),
		'%Y-%m-%d %T'
	);
set in_descriptions = JSON_UNQUOTE(
		JSON_EXTRACT(in_goodsReceipts, '$.goodsReceipts.descriptions')
	);
set in_users_recipient_id = JSON_UNQUOTE(
		JSON_EXTRACT(
			in_goodsReceipts,
			'$.goodsReceipts.usersRecipientId'
		)
	);
set in_users_creator_id = JSON_UNQUOTE(
		JSON_EXTRACT(
			in_goodsReceipts,
			'$.goodsReceipts.userCreatorsId'
		)
	);
set in_suppliers_id = JSON_UNQUOTE(
		JSON_EXTRACT(in_goodsReceipts, '$.goodsReceipts.suppliersId')
	);
set in_places_id = JSON_UNQUOTE(
		JSON_EXTRACT(in_goodsReceipts, '$.goodsReceipts.placesId')
	);
set in_status = IF(
		JSON_UNQUOTE(
			JSON_EXTRACT(in_goodsReceipts, '$.goodsReceipts.status')
		) = 'true',
		true,
		false
	);
...
set in_medicines_id = JSON_UNQUOTE(
		JSON_EXTRACT(
			in_goodsReceipts,
			concat('$.goodsReceipts.detail[', _index, '].medicinesId')
		)
	);
set in_lotnumber = JSON_UNQUOTE(
		JSON_EXTRACT(
			in_goodsReceipts,
			concat('$.goodsReceipts.detail[', _index, '].lotNumber')
		)
	);
set in_quantities_request = JSON_UNQUOTE(
		JSON_EXTRACT(
			in_goodsReceipts,
			concat(
...
set in_quantities_received = JSON_UNQUOTE(
		JSON_EXTRACT(
			in_goodsReceipts,
			concat(
				'$.goodsReceipts.detail[',
...
set in_price = JSON_UNQUOTE(
		JSON_EXTRACT(
			in_goodsReceipts,
			concat('$.goodsReceipts.detail[', _index, '].price')
		)
	);
set in_expired_date = STR_TO_DATE(
		JSON_UNQUOTE(
			JSON_EXTRACT(
				in_goodsReceipts,
				concat('$.goodsReceipts.detail[', _index, '].expiredDate')
			)
		),
		'%Y-%m-%d %T'
	);
set in_retail_price = JSON_UNQUOTE(
		JSON_EXTRACT(
			in_goodsReceipts,
			concat('$.goodsReceipts.detail[', _index, '].retailPrice')
		)
	);
set in_wholesale_price = JSON_UNQUOTE(
		JSON_EXTRACT(
			in_goodsReceipts,
			concat(
				'$.goodsReceipts.detail[',
...
set in_retail_quantities = JSON_UNQUOTE(
		JSON_EXTRACT(
			in_goodsReceipts,
			concat(
				'$.goodsReceipts.detail[',
...
set in_manufacturingDate = STR_TO_DATE(
		JSON_UNQUOTE(
			JSON_EXTRACT(
				in_goodsReceipts,
				concat(
...
values(
		med_goods_receipts_id,
		in_medicines_id,
		in_lotnumber,
		in_quantities_request,
		in_quantities_received,
		in_price,
		in_expired_date,
		in_retail_quantities,
		in_retail_quantities,
		in_manufacturingDate
	);
update med_medicines
set retail_price = in_retail_price,
	wholesale_price = in_wholesale_price
...
set in_id = JSON_UNQUOTE(
		JSON_EXTRACT(in_goodsReceipts, '$.goodsReceipts.id')
	);
set in_receipt_code = JSON_UNQUOTE(
		JSON_EXTRACT(in_goodsReceipts, '$.goodsReceipts.receiptCode')
	);
...
if exists (
	select *
	from med_goods_receipts
	where id = in_id
) then
set out_output = 1;
update med_goods_receipts
set receipt_code = in_receipt_code,
...
where id = in_id;
WHILE _index < in_length_goods_receipts_detail DO
set in_detail_id = JSON_UNQUOTE(
		JSON_EXTRACT(
			in_goodsReceipts,
			concat('$.goodsReceipts.detail[', _index, '].id')
		)
	);
set in_medicines_id = JSON_UNQUOTE(
		JSON_EXTRACT(
...
set in_flag = JSON_UNQUOTE(
		JSON_EXTRACT(
			in_goodsReceipts,
			concat('$.goodsReceipts.detail[', _index, '].flag')
		)
	);
if(in_status = true) then if(in_flag = 0) then
set in_whosale_quantities_old = (
		select quantities_received
		from med_goods_receipt_detail
		where id = in_detail_id
	);
set in_retail_quantities_old = (
		select retail_quantities
		from med_goods_receipt_detail
		where id = in_detail_id
	);
set in_check_receipt_detail = ifnull(
		(
			select if(in_quantities_received <= sum(quantites), 1, 0)
			from med_goods_issue_receipt_detail
			where goods_receipt_detail_id = in_detail_id
		),
		1
	);
if (in_check_receipt_detail = 1) then
update med_goods_receipt_detail
set -- goods_receipts_id =
	medicines_id = in_medicines_id,
...
elseif(in_flag = -1) then if exists (
	select *
	from med_goods_issue_receipt_detail
	where goods_receipt_detail_id = in_detail_id
) then
...
delete from med_goods_receipt_detail
where id = in_detail_id;
end if;
elseif(in_flag = 1) then
insert into med_goods_receipt_detail(
...
execute stmt1;
select distinct(val)
from temp_ByCustomerid;
if(in_lstCustomerid = '0') then DROP TEMPORARY TABLE IF EXISTS temp_customer;
CREATE TEMPORARY TABLE temp_customer (
	select u.id,
		u.name,
(
			(
				issue_detail.price * issue_receipt_detail.quantites
			) - issue_detail.discounts
		) as total,
		issues.debit,
		(
			(
				...
				issue_detail.quantities *(
					case
						when issue_detail.is_retail = false then receipt_detail.price
						else ROUND(
							receipt_detail.quantities_received * receipt_detail.price / receipt_detail.retail_quantities,
							0
						)
					end
				)
	...
	where date_format(issues.issue_date, '%Y%m%d') >= date_format(in_dtfrom, '%Y%m%d')
		and date_format(issues.issue_date, '%Y%m%d') <= date_format(in_dtto, '%Y%m%d') -- and exists(select * from temp_ByCustomerid where temp_ByCustomerid.val=issues.customers_id)
		and group_cus.id <> 1
);
else DROP TEMPORARY TABLE IF EXISTS temp_customer;
CREATE TEMPORARY TABLE temp_customer (
	select u.id,
		u.name,
(
	...
	where date_format(issues.issue_date, '%Y%m%d') >= date_format(in_dtfrom, '%Y%m%d')
		...
		and exists(
			select *
			from temp_ByCustomerid
			where temp_ByCustomerid.val = issues.customers_id
		)
		and group_cus.id <> 1
);
end if;
...
CREATE TEMPORARY TABLE temp_report_byCustomer (
	select id,
		...
		COALESCE(
			SUM(
				CASE
					WHEN debit = 1 THEN total
					ELSE 0
				END
			),
			0
		) AS 'debts',
		COALESCE(SUM(total), 0) AS 'totalMoney',
...
WHERE t.rownum >= start_page
	and t.rownum <= end_page;
...
execute stmt1;
select distinct(val)
from tempMedicinesid;
if(in_lstmedicinesid = '0') then DROP TEMPORARY TABLE IF EXISTS temp_Medicines;
...
(
	...
	where date_format(issues.issue_date, '%Y%m%d') >= date_format(in_dtfrom, '%Y%m%d')
		and date_format(issues.issue_date, '%Y%m%d') <= date_format(in_dtto, '%Y%m%d') -- and exists(select * from tempMedicinesid where tempMedicinesid.val=issue_detail.medicines_id)
);
else DROP TEMPORARY TABLE IF EXISTS temp_Medicines;
CREATE TEMPORARY TABLE temp_Medicines (
	select medicines.id,
		medicines.name,
(
	...
	where date_format(issues.issue_date, '%Y%m%d') >= date_format(in_dtfrom, '%Y%m%d')
		...
		and exists(
			select *
			from tempMedicinesid
			where tempMedicinesid.val = issue_detail.medicines_id
		)
);
end if;
...
insert into t_warehouses_ExpiredDate
values(in_lstwarehouses);
...
set @sql = concat(
		"insert into temp_warehouseid_ExpiredDate (val) values ('",
		replace(
			(
				select group_concat(distinct txt) as data
				from t_warehouses_ExpiredDate
			),
			",",
			"'),('"
		),
...
insert into t_groupmedicines_ExpiredDate
values(in_lstgroupmedicines);
...
set @sql2 = concat(
		"insert into temp_groupmedicines_ExpiredDate (val) values ('",
		replace(
			(
				select group_concat(distinct txt) as data
				from t_groupmedicines_ExpiredDate
			),
			",",
			"'),('"
		),
...
insert into t_medicines_ExpiredDate
values(in_lstmedicines);
...
set @sql3 = concat(
		"insert into temp_medicines_ExpiredDate (val) values ('",
		replace(
			(
				select group_concat(distinct txt) as data
				from t_medicines_ExpiredDate
			),
			",",
			"'),('"
		),
...
from @sql3;
execute stmt3;
if (in_lstwarehouses = '0') then DROP TEMPORARY TABLE IF EXISTS temp_medicine_ExpiredDate;
CREATE TEMPORARY TABLE temp_medicine_ExpiredDate (
	select group_medicine.name as groupMedicineName,
		medicine.barcode,
		medicine.name,
		unit.name as unitName,
		receipt_detail.lotnumber,
		receipt_detail.expired_date,
		receipt_detail.quantities_in_stock,
		round(
			(
				receipt_detail.quantities_received * receipt_detail.price / receipt_detail.retail_quantities
		...
		round(
			...
			0
		) * receipt_detail.quantities_in_stock as totalMoney
	...
	where receipt.places_id = in_lstplaceid -- and medicine.status=1
		and (
			(
				exists(
					select *
					from temp_groupmedicines_ExpiredDate
					where temp_groupmedicines_ExpiredDate.val = group_medicine.id
				)
		...
		and (
			(
				exists(
					select *
					from temp_medicines_ExpiredDate
					where temp_medicines_ExpiredDate.val = medicine.id
				)
				and in_lstgroupmedicines <> '0'
			)
...
else DROP TEMPORARY TABLE IF EXISTS temp_medicine_ExpiredDate;
CREATE TEMPORARY TABLE temp_medicine_ExpiredDate (
	select group_medicine.name as groupMedicineName,
		medicine.barcode,
		medicine.name,
	...
	where receipt.places_id = in_lstplaceid -- and medicine.status=1
		and exists(
			select *
			from temp_warehouseid_ExpiredDate
			where temp_warehouseid_ExpiredDate.val = receipt.warehouses_id
		)
		and (
			(
				exists(
...
SET out_total_money = (
		SELECT sum(ifnull(totalMoney, 0))
		FROM temp_report_medicine_ExpiredDate
	);
SET out_row_count = (
		SELECT COUNT(*)
		FROM temp_report_medicine_ExpiredDate
...
set @sql = concat(
		"insert into temp_warehouseid_OutofStock (val) values ('",
		replace(
			(
				select group_concat(distinct txt) as data
				from t_medicine_OutofStock
			),
			",",
			"'),('"
		),
...
insert into t_groupmedicines_OutofStock
values(in_lstgroupmedicines);
...
set @sql2 = concat(
		"insert into temp_groupmedicines_OutofStock (val) values ('",
		replace(
			(
				select group_concat(distinct txt) as data
				from t_groupmedicines_OutofStock
			),
			",",
			"'),('"
		),
...
from @sql2;
execute stmt2;
if (in_lstwarehouses = '0') then DROP TEMPORARY TABLE IF EXISTS temp_medicine_OutofStock;
CREATE TEMPORARY TABLE temp_medicine_OutofStock (
	select group_medicine.name as groupMedicineName,
		medicine.barcode,
		medicine.name,
		in_alert_number_in_stock,
		receipt_detail.quantities_in_stock
	from med_goods_receipts as receipt
		inner join med_goods_receipt_detail as receipt_detail on receipt_detail.goods_receipts_id = receipt.id
		inner join med_medicines as medicine on medicine.id = receipt_detail.medicines_id
	...
	where receipt.places_id = in_lstplaceid -- and medicine.status=1
		...
		and (
			(
				exists(
					select *
					from temp_groupmedicines_OutofStock
...
else DROP TEMPORARY TABLE IF EXISTS temp_medicine_OutofStock;
CREATE TEMPORARY TABLE temp_medicine_OutofStock (
	select group_medicine.name as groupMedicineName,
		medicine.barcode,
		medicine.name,
	...
	where receipt.places_id = in_lstplaceid -- and medicine.status=1
		...
		and exists(
			select *
			from temp_warehouseid_OutofStock
			where temp_warehouseid_OutofStock.val = receipt.warehouses_id
		)
		and (
			(
				exists(
...
set @sql = concat(
		"insert into temp_ByStaffid (val) values ('",
		replace(
			(
				select group_concat(distinct txt) as data
				from t_byUserID
...
select distinct(val)
from temp_ByStaffid;
if (in_lstuserid = '0') then DROP TEMPORARY TABLE IF EXISTS temp_staff;
...
(
	...
	from med_goods_issues as issues
		...
		inner join med_goods_receipt_detail as receipt_detail on receipt_detail.id = issue_receipt_detail.goods_receipt_detail_id
	where date_format(issues.issue_date, '%Y%m%d') >= date_format(in_dtfrom, '%Y%m%d')
		and date_format(issues.issue_date, '%Y%m%d') <= date_format(in_dtto, '%Y%m%d') -- and exists(select * from temp where temp.val=issues.users_seller_id)
);
else DROP TEMPORARY TABLE IF EXISTS temp_staff;
CREATE TEMPORARY TABLE temp_staff (
	select u.id,
		u.fullname,
(
	...
	where date_format(issues.issue_date, '%Y%m%d') >= date_format(in_dtfrom, '%Y%m%d')
		...
		and exists(
			select *
			from temp_ByStaffid
			where temp_ByStaffid.val = issues.users_seller_id
		)
);
end if;
...
insert into t_bySuppilersID
values(in_lstSuppliersid);
drop temporary table if exists temp_BySuppliersid;
create temporary table temp_BySuppliersid(val nvarchar(50));
set @sql = concat(
		"insert into temp_BySuppliersid (val) values ('",
		replace(
			(
				select group_concat(distinct txt) as data
				from t_bySuppilersID
			),
			",",
			"'),('"
		),
...
execute stmt1;
select distinct(val)
from temp_BySuppliersid;
if(in_lstSuppliersid = '0') then DROP TEMPORARY TABLE IF EXISTS temp_supplier;
...
(
		...
		(
			(
				...
				issue_receipt_detail.quantites *(
					case
						when issue_detail.is_retail = false then receipt_detail.price
						else ROUND(
							receipt_detail.quantities_received * receipt_detail.price / receipt_detail.retail_quantities,
	...
	where date_format(issues.issue_date, '%Y%m%d') >= date_format(in_dtfrom, '%Y%m%d')
		and date_format(issues.issue_date, '%Y%m%d') <= date_format(in_dtto, '%Y%m%d') -- and exists(select * from temp_BySuppliersid where temp_BySuppliersid.val=issues.customers_id)
);
else DROP TEMPORARY TABLE IF EXISTS temp_supplier;
CREATE TEMPORARY TABLE temp_supplier (
	select supplier.id,
		supplier.name,
(
	...
	where date_format(issues.issue_date, '%Y%m%d') >= date_format(in_dtfrom, '%Y%m%d')
		...
		and exists(
			select *
			from temp_BySuppliersid
			where temp_BySuppliersid.val = receipts.suppliers_id
		)
);
end if;
...
CREATE TEMPORARY TABLE temp_places_1 (
	select date_format(issues.issue_date, '%d-%m-%Y') as createdate,
		...
		sum(
			case
				when issues.debit = true then issue_detail.price * issue_detail.quantities
				else 0
			end
...
CREATE TEMPORARY TABLE temp_places_2 (
	select date_format(receipts.date_receipt, '%d-%m-%Y') as createdate,
		sum(
			receipt_detail.quantities_received * receipt_detail.price
		) as 'totalValueReceipt',
		sum(
			round(
				(
					(
						receipt_detail.quantities_in_stock / round(
							receipt_detail.retail_quantities / receipt_detail.quantities_received,
							0
						)
		...
		) as 'revenueTotalInventory',
		sum(
			case
				when receipts.debit = true then receipt_detail.quantities_received * receipt_detail.price
				else 0
			end
...
CREATE TEMPORARY TABLE temp_report_byPlace (
	select t.createdate,
		ifnull(temp_places_2.totalValueReceipt, 0) as totalValueReceipt,
...
SET out_totalValueReceipt = (
		SELECT sum(ifnull(totalValueReceipt, 0))
		FROM temp_report_byPlace
	);
SET out_revenueTotal = (
		SELECT sum(ifnull(revenueTotal, 0))
		FROM temp_report_byPlace
	);
SET out_revenueTotalInventory = (
		SELECT sum(ifnull(revenueTotalInventory, 0))
		FROM temp_report_byPlace
	);
SET out_revenueTotalDebit = (
		SELECT sum(ifnull(revenueTotalDebit, 0))
		FROM temp_report_byPlace
	);
SET out_revenueTotalDebitSupplier = (
		SELECT sum(ifnull(revenueTotalDebitSupplier, 0))
		FROM temp_report_byPlace
	);
SET out_revenueTotalprofit = (
		SELECT sum(ifnull(revenueTotalprofit, 0))
		FROM temp_report_byPlace
	);
SET out_row_count = (
		SELECT COUNT(*)
...
CREATE TEMPORARY TABLE temp_revenue_detail_byPlaceid (
	select u.name as customerName,
		issues.issue_code as issueCode,
		medicines.barcode,
...
SET out_total_discounts = (
		SELECT sum(ifnull(discounts, 0))
		FROM temp_revenue_detail_byPlaceid
	);
...
SELECT CONCAT(t1.id, '-', UserID) as id,
	...
	(
		case
			when t2.is_view is null then false
			else t2.is_view
		end
	) IsView,
	(
		case
			when t2.is_new is null then false
			else t2.is_new
		end
	) IsInsert,
	(
		case
			when t2.is_update is null then false
			else t2.is_update
		end
	) IsUpdate,
	(
		case
			when t2.is_delete is null then false
			else t2.is_delete
		end
	) IsDelete
FROM (
		SELECT tc.id,
			...
			IFNULL(
				(
					select id
					from roles
					where roles.users_id = UserID
						and roles.menus_id = tc.id
				),
				0
			) RoleId,
			IFNULL(
	...
	left join (
		...
		WHERE rt.groups_users_id = GroupUserID
			and rt.sites_id = SiteID
	) t2 on t1.id = t2.menus_id
...
SELECT CONCAT(t1.id, '-', UserID) as id,
	...
	(
		case
			when t2.is_view is null then t1.IsView
			else t2.is_view
		end
	) IsView,
	(
		case
			when t2.is_new is null then t1.IsInsert
			else t2.is_new
		end
	) IsInsert,
	(
		case
			when t2.is_update is null then t1.IsUpdate
			else t2.is_update
		end
	) IsUpdate,
	(
		case
			when t2.is_delete is null then t1.IsDelete
			else t2.is_delete
		end
	) IsDelete -- 			(case when t2.is_view is null then false else t2.is_view end) IsView,
...
DELIMITER;
;
CREATE DEFINER = `root` @`%` PROCEDURE `tblRoleDetail_Update_NewCms`(json JSON, userId BIGINT) BEGIN
...
set _IsInsert := (
		JSON_EXTRACT(json, CONCAT('$[', _index, '].IsInsert'))
	);
set _IsView := (
		JSON_EXTRACT(json, CONCAT('$[', _index, '].IsView'))
	);
set _IsUpdate := (
		JSON_EXTRACT(json, CONCAT('$[', _index, '].IsUpdate'))
	);
set _IsDelete := (
		JSON_EXTRACT(json, CONCAT('$[', _index, '].IsDelete'))
	);
set _SiteId := (
		JSON_EXTRACT(json, CONCAT('$[', _index, '].SiteId'))
	);
...
SET roles.is_new = _IsInsert,
	...
	roles.is_view = _IsView -- 				Roles.IsStatus = _IsStatus
...
FROM (
		SELECT tc.id,
			...
			IFNULL(
				(
					...
					where roles_templates.groups_users_id = GroupUserID
						and roles_templates.menus_id = tc.id
				),
				0
			) RoleId,
			IFNULL(
		...
		WHERE tc.status = 1
			...
			and tc.sites_id = (
				case
					when SiteID = -1 then tc.sites_id
					else SiteID
				end
			)
	) t1
...
DELIMITER;
;
CREATE DEFINER = `root` @`%` PROCEDURE `tblroleTemplateDetail_Update_NewCms`(json JSON, groupUserId BIGINT) BEGIN
DECLARE json_items_length BIGINT UNSIGNED DEFAULT JSON_LENGTH(json);
DECLARE _index BIGINT UNSIGNED DEFAULT 0;
DECLARE _IsDelete TINYINT(1) default false;
DECLARE _IsUpdate TINYINT(1) default false;
...
SET roles_templates.is_new = _IsInsert,
	...
	roles_templates.is_view = _IsView -- 				Roles.IsStatus = _IsStatus
...
select *
from roles_templates
where groups_users_id = groupUserId;
END;
;
DELIMITER;
/*!50003 SET sql_mode              = @saved_sql_mode */
...
DELIMITER;
;
CREATE DEFINER = `root` @`%` PROCEDURE `test`() BEGIN if ifnull(
	(
		select if(quantities_in_stock < 100, 1, 0)
		from med_goods_receipt_detail
		where id = 0
	),
	0
...
DELIMITER;
;
CREATE DEFINER = `root` @`%` PROCEDURE `update_places_users`(
	in in_users_id VARCHAR(20),
	in in_users_creator_id VARCHAR(20),
	in in_lst_places VARCHAR(255)
) BEGIN #Routine body goes here...
DECLARE lst_places VARCHAR(255);
DECLARE EXIT HANDLER for SQLWARNING,
	SQLEXCEPTION BEGIN -- WARNING
	ROLLBACK;
SELECT 0 as status;
END;
START TRANSACTION;
IF in_lst_places != '' THEN drop TEMPORARY table if exists tmp_places;
create TEMPORARY table tmp_places
SELECT id as placesId
FROM places
WHERE FIND_IN_SET(id, in_lst_places);
SET lst_places = (
		select group_concat(distinct placesId) as data
		from tmp_places
	);
IF NOT ISNULL(lst_places) THEN
DELETE FROM places_users
WHERE users_id = in_users_id;
set @sql = concat(
		"insert into places_users (places_id, users_id, users_creator_id, status) values (",
		replace(
			lst_places,
			",",
			concat(
